...
It is not necessary in our context, as we only want the first implication. If this rafinement is nevertheless wanted, it can be obtained by defining a new proposition true only in state $\Omega$. % I don't understand. Does this mean that the reverse transformation does not preserve trace-equivalence?
